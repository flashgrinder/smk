                ...
                <nav class="footer__menu menu">
                    <ul class="menu__list footer__menu-list">
                        <li class="menu__item footer__menu-item">
                            <a href="#services" class="menu__link footer__menu-link js-anchor-link">
                                Услуги
                            </a>
                        </li>
                        <li class="menu__item footer__menu-item">
                            <a href="#thechnique" class="menu__link footer__menu-link js-anchor-link">
                                Спецтехника
                            </a>
                        </li>
                        <li class="menu__item footer__menu-item">
                            <a href="#about" class="menu__link footer__menu-link js-anchor-link">
                                О компании
                            </a>
                        </li>
                        <li class="menu__item footer__menu-item">
                            <a href="#managment"class="menu__link footer__menu-link js-anchor-link">
                                Менеджмент
                            </a>
                        </li>
                        <li class="menu__item footer__menu-item">
                            <a href="#contacts" class="menu__link footer__menu-link js-anchor-link">
                                Контакты
                            </a>
                        </li>
                    </ul>
